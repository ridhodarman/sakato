...
if (isset($_POST['tambah'])) {
    ...
    $atur_eskalasi                   = isset($_POST['atur_eskalasi']) ? 1 : 0;

    $stmt = $koneksi->prepare("
        INSERT INTO akun_sakato
        (
            username,
            password,
            nama,
            pic_id,
            kelola_layanan_posisi_harilibur,
            lihat_semua_warning,
            kelola_pic_akun,
            update_berkas,
            atur_eskalasi
                                ...
                                <td>
                                    ...
                                    <?php if ($row['kelola_layanan_posisi_harilibur']): ?>
                                        ...
                                        <span class="badge badge-success">
                                            Kelola Data Layanan, Posisi & Hari Libur
                                        </span>
                                                ...
                                                <div class="form-group border p-3 rounded">
                                                    ...
                                                    <div class="custom-control custom-checkbox mb-2">
                                                        ...
                                                        <input
                                                            ...
                                                            id="edit_hk1_<?= $row['id']; ?>"
                                                            name="kelola_layanan_posisi_harilibur"
                                                            value="1"
                                                            <?= $row['kelola_layanan_posisi_harilibur'] ? 'checked' : ''; ?>>

                                                        <label
                                                            class="custom-control-label"
                                                            for="edit_hk1_<?= $row['id']; ?>">

                                                            Kelola Data Layanan, Posisi, dan Hari Libur
                                                    ...
                                                    <div class="custom-control custom-checkbox mb-2">
                                                        ...
                                                        <input
                                                            ...
                                                            class="custom-control-input"
                                                            id="edit_hk2_<?= $row['id']; ?>"
                                                            name="lihat_semua_warning"
                                                            value="1"
                                                            <?= $row['lihat_semua_warning'] ? 'checked' : ''; ?>>

                                                        <label
                                                            class="custom-control-label"
                                                            for="edit_hk2_<?= $row['id']; ?>">
                                                    ...
                                                    <div class="custom-control custom-checkbox mb-2">
                                                        ...
                                                        <input
                                                            ...
                                                            class="custom-control-input"
                                                            id="edit_hk3_<?= $row['id']; ?>"
                                                            name="kelola_pic_akun"
                                                            value="1"
                                                            <?= $row['kelola_pic_akun'] ? 'checked' : ''; ?>>

                                                        <label
                                                            class="custom-control-label"
                                                            for="edit_hk3_<?= $row['id']; ?>">
                                                    ...
                                                    <div class="custom-control custom-checkbox mb-2">
                                                        ...
                                                        <input
                                                            ...
                                                            name="update_berkas"
                                                            value="1"
                                                            <?= $row['update_berkas'] ? 'checked' : ''; ?>>

                                                        <label
                                                            class="custom-control-label"
                                                            for="edit_hk4_<?= $row['id']; ?>">
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <input
                                                            ...
                                                            name="atur_eskalasi"
                                                            value="1"
                                                            <?= $row['atur_eskalasi'] ? 'checked' : ''; ?>>

                                                        <label
                                                            class="custom-control-label"
                                                            for="edit_hk5_<?= $row['id']; ?>">
                            ...
                            <div class="form-group border p-3 rounded">
                                ...
                                <div class="custom-control custom-checkbox mb-2">
                                    ...
                                    <label
                                        ...
                                        Kelola Layanan Posisi Hari Libur
