...
<title>SAKATO V2 - Pusat Eskalasi</title><link rel="stylesheet" href="assets/style.css"></head><body>
...
</nav><div class="logout"><button id="logout" class="btn light" style="width:100%" onclick="logout()">Keluar</button></div></aside><main class="main"><div class="top"><div><h1>Pusat Eskalasi</h1><div class="muted">Kolaborasi lintas seksi dan dukungan keputusan pimpinan.</div></div><div class="top-actions"><span id="date" class="pill"></span></div></div><section id="eskalasi" class="section active"><div class="card"><h3>Pusat Eskalasi</h3><div class="muted" style="margin-bottom:11px">Untuk dukungan lintas seksi atau keputusan pimpinan.</div><div id="esclist"></div></div></section></main></div>
